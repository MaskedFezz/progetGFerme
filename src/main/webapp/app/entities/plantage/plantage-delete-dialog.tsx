...
export const PlantageDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gestionDesFermesApp.plantage.delete.question">
        <Translate contentKey="gestionDesFermesApp.plantage.delete.question" interpolate={{ id: plantageEntity.id }}>

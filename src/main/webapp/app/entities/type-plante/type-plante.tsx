  ...
  return (
    <div>
      <h2 id="type-plante-heading" data-cy="TypePlanteHeading">
        <Translate contentKey="gestionDesFermesApp.typePlante.home.title">Type Plantes</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="gestionDesFermesApp.typePlante.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/type-plante/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="gestionDesFermesApp.typePlante.home.createLabel">Create new Type Plante</Translate>
          </Link>
        </div>
      </h2>
        ...
        {typePlanteList && typePlanteList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="gestionDesFermesApp.typePlante.id">ID</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('id')} />
                </th>
                <th className="hand" onClick={sort('nom')}>
                  <Translate contentKey="gestionDesFermesApp.typePlante.nom">Nom</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('nom')} />
                </th>
                <th className="hand" onClick={sort('humiditeMax')}>
                  <Translate contentKey="gestionDesFermesApp.typePlante.humiditeMax">Humidite Max</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('humiditeMax')} />
                </th>
                <th className="hand" onClick={sort('humiditeMin')}>
                  <Translate contentKey="gestionDesFermesApp.typePlante.humiditeMin">Humidite Min</Translate>{' '}
                  <FontAwesomeIcon icon={getSortIconByFieldName('humiditeMin')} />
                </th>
                <th className="hand" onClick={sort('temperature')}>
                  <Translate contentKey="gestionDesFermesApp.typePlante.temperature">Temperature</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="gestionDesFermesApp.typePlante.home.notFound">No Type Plantes found</Translate>
            </div>
          )
        )}
      </div>

  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gestionDesFermesApp.typePlante.home.createOrEditLabel" data-cy="TypePlanteCreateUpdateHeading">
            <Translate contentKey="gestionDesFermesApp.typePlante.home.createOrEditLabel">Create or edit a TypePlante</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('gestionDesFermesApp.typePlante.nom')}
                id="type-plante-nom"
                name="nom"
                data-cy="nom"
                type="text"
              />
              <ValidatedField
                label={translate('gestionDesFermesApp.typePlante.humiditeMax')}
              ...
              />
              <ValidatedField
                label={translate('gestionDesFermesApp.typePlante.humiditeMin')}
              ...
              />
              <ValidatedField
                label={translate('gestionDesFermesApp.typePlante.temperature')}
